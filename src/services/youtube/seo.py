...
CHANNEL_KEYWORDS: dict[ChannelType, list[str]] = {
    ChannelType.HORROR: [
        "공포", "미스터리", "무서운", "심령", "귀신", "소름", "실화",
        "horror", "scary", "creepy", "ghost", "paranormal", "mystery",
    ],
    ChannelType.FACTS: [
        "과학", "팩트", "사실", "놀라운", "충격", "진실", "상식",
        "facts", "science", "amazing", "truth", "mind-blowing",
    ],
    ChannelType.FINANCE: [
        "투자", "주식", "부동산", "돈", "재테크", "경제", "수익", "배당",
        "investing", "money", "finance", "stocks", "wealth", "passive income",
    ],
}
...
class SEOOptimizer:
    ...
    def _get_trending_tags(self) -> list[str]:
        base_tags: dict[ChannelType, list[str]] = {
            ChannelType.HORROR: [
                "무서운이야기", "공포영상", "심령체험", "괴담", "horror story",
            ],
            ChannelType.FACTS: [
                "신기한사실", "과학영상", "상식", "교양", "facts you didnt know",
            ],
            ChannelType.FINANCE: [
                "주식추천", "부동산투자", "재테크방법", "경제공부", "money tips",
            ],
        }
